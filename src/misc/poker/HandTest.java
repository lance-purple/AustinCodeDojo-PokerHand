...
public class HandTest {
   ...
   private static final String PAIR_OF_TWOS_WITH_6_KICKER = "2h,2c,3d,4c,6d";
	...
	assertEquals("high hand should beat low hand", highHand.beats(lowHand), Outcome.win);
    }
	...
	assertEquals("lowHand cannot beat high hand", lowHand.beats(highHand), Outcome.lose);
    }
	...
	assertEquals("ten should beat low hand", tenHand.beats(lowHand), Outcome.win);
    }
	...
	assertEquals("jack should beat ten hand", jackHand.beats(lowHand), Outcome.win);
    }
	...
	assertEquals("lowHand cannot beat high hand", highHand.beats(lowHand), Outcome.win);
    }
